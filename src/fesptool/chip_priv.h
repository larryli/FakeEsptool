...
#define FESP_MAC_EFUSE_WORD0_ESP8266                                                \
    (FESP_EFUSE_RD_REG_BASE_ESP8266 + 0x00)
#define FESP_MAC_EFUSE_WORD1_ESP8266                                                \
    (FESP_EFUSE_RD_REG_BASE_ESP8266 + 0x04)
#define FESP_MAC_EFUSE_WORD3_ESP8266                                                \
    (FESP_EFUSE_RD_REG_BASE_ESP8266 + 0x0C)
