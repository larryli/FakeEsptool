...
|------|------|-----------|---------|------|
| ESP32-C5 | WiFi 6双频+BT5+802.15.4, RISC-V单核+LP核240MHz | 0x600B4800 | 0x60003000 | 40/48MHz |
| ESP32-C61 | WiFi 6+BT5, RISC-V单核160MHz | 0x600B4800 | 0x60003000 | 40MHz |
| ESP32-H2 | BT5+802.15.4, RISC-V单核96MHz | 0x600B0800 | 0x60003000 | 32MHz |
| ESP32-P4 | 高性能MCU, 无无线 | 0x5012D000 | 0x5008D000 | 40MHz |

**实现内容：**
- chip.h: 添加 FESP_CHIP_ESP32C5、FESP_CHIP_ESP32C61、FESP_CHIP_ESP32H2、FESP_CHIP_ESP32P4 枚举
- chip.c: 实现 init_esp32c5、init_esp32c61、init_esp32h2、init_esp32p4 初始化函数
